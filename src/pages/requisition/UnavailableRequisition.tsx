...
import ItemRequest from "../../components/ItemRequest/Index";
import { useState } from "react";

const UnavailableRequisition = () => {
  ...
  // ("/RequisitionsNotAvailableByCreatedByList");
  const {
    response,
    loading,
  ...
  return (
    <Layout>
      <>
        <ItemRequest isOpen={isOpen} onClose={onClose} user={user} />
        <BackBtn />
        <Box
          display={"flex"}
...
export default UnavailableRequisition;
