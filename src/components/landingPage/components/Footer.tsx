...
function Footer() {
  return (
    <div className="asset__footer" id="contact">
      <div className="asset__footer-contact_info">
        <div className="footer__content">
          <div className="footer__id">
            ...
            <div className="asset__footer-contact">
              ...
              <p>
                ...
                <strong>Email:</strong> info@asset.bz
              </p>
          ...
          <div className="asset__footer-message">
            ...
            <p>
              Want to integrate AIMS into your service center. We would love to
              have you onboard. Please provide your details below.
            </p>
            <form action="">
